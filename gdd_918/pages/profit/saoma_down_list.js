...
Page({
  ...
  carPhoto45Change: function () {
    ...
    wx.chooseImage({
      ...
      success: function (res) {
        ...
        console.log('task_id = ' + that.data.task_id + ' ; session_id = ' + that.data.session_id + ' ; filePath = ' + tempFilePath[0]);
        wx.uploadFile({
  ...
  formSubmit: function (e) {
    ...
    //下刊扫码提交
    wx.request({
      url: that.data.request_url +'task.php?action=down_scan',
      data: {
  ...
  onShareAppMessage: function (e) {
    ...
    return {
      title: '广点点（广告接单平台）',
      path: '/pages/index/index?from=saoma_down_list',
      success: function (res) {
        // 转发成功
      },
      fail: function (res) {
